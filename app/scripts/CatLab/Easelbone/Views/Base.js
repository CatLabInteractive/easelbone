define(
    ...
    function (
        ...
        return Backbone.View.extend({
             ...
             * @returns {Array}
             */
            findPlaceholders: function (container, name) {
                var out = [];
                var placeholders = this.findFromNames(container, name);
             ...
             * @returns {Array}
             */
            findFromNames: function (containers, names) {
                ...
                names.forEach(function (name) {
                    ...
                    containers.forEach(function (container) {
                        ...
                        if (nameParts.length > 0) {
                            elements = this.findFromNames(elements, nameParts.join('.'));
                        }
